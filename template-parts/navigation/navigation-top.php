...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top py-3 <?php echo $have_bg ?>" style="z-index: 100; background-color:black;">
        <div class="container">
            <?php
...
if (has_nav_menu('top')):
    ...
    // array(
    // 'menu' => 'Top Submenu',
    // 'menu_class' => 'header_group navbar navbar-expand-lg bg-pink-500  fixed-top py-3',
